      ...
      <details className="mt-3 rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-600">
        ...
        <div className="mt-2 space-y-2 leading-relaxed">
          <p>
            ...
            שני עקרונות חשובים: סדר הנושאים שבחרתם קובע את משקלם (50/30/20), ורכיבים
            שסימנתם בהם "לא משנה לי" יוצאים מהנוסחה לגמרי במקום להוסיף לכולם ציון זהה.
            כך הציונים מתפרסים ומבחינים באמת בין מועמדים:
          </p>
