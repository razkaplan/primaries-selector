    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-5xl px-4 py-10">
        ...
        <p className="mt-3 max-w-2xl leading-relaxed text-neutral-600">
          התבטאויות פומביות של המועמדים כפי שפורסמו ברשתות ובתקשורת. לכל ציטוט
          מוצמדים תאריך וקישור למקור, וכל ציטוט ניתן לשיתוף כתמונה. זהו איסוף
          ראשוני (מדגם ממנהיגי המפלגות); הצנרת המלאה אוספת עבור כל המועמדים
          הריאליים — ראו{" "}
          <a
